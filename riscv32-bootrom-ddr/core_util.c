...
check_data_types()
{
    ...
    if (sizeof(ee_u8) != 1)
    {
        puts("ERROR: ee_u8 is not an 8b datatype!\n");
        retval++;
    }
    if (sizeof(ee_u16) != 2)
    {
        puts("ERROR: ee_u16 is not a 16b datatype!\n");
        retval++;
    }
    if (sizeof(ee_s16) != 2)
    {
        puts("ERROR: ee_s16 is not a 16b datatype!\n");
        retval++;
    }
    if (sizeof(ee_s32) != 4)
    {
        puts("ERROR: ee_s32 is not a 32b datatype!\n");
        retval++;
    }
    if (sizeof(ee_u32) != 4)
    {
        puts("ERROR: ee_u32 is not a 32b datatype!\n");
        retval++;
    }
    ...
    if (retval > 0)
    {
        puts("ERROR: Please modify the datatypes in core_portme.h!\n");
    }
    return retval;
}
